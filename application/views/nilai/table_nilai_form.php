...
?>
 <div class="page-container">
        ...
        <label class="col-lg-3 control-label">NIM Mahasiswa</label>
            <div class="col-lg-9">
           <select name="table_mahasiswa_nim" id="table_mahasiswa_nim" class="select-search" placeholder="Pilih..."  />
            <option></option>
            <?php 
            ...
            ?>
              <option  value="<?php echo $value->nim; ?>"  echo ' selected'; >
         ...
         <div class="form-group">
           <label class="col-lg-3 control-label">Pilih Matakuliah</label>
            <div class="col-lg-9">
           <select name="table_matakuliah_kode_matakuliah" id="table_matakuliah_kode_matakuliah" class="select-search" placeholder="Pilih..."  />
            <option></option>
            <?php 
            $mahasiswa=$this->db->query("select * from table_matakuliah");
            ...
            ?>
              <option  value="<?php echo $value->kode_matakuliah; ?>"  echo ' selected'; >
