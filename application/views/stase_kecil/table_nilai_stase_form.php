...
<div class="page-container">
	...
	<fieldset title="1">
        <legend class="text-semibold">FORMATIF</legend>
            ...
            <label>Pilih Koas</label>
            <select name="table_koas_nim" id="table_koas_nim"
            autocomplete="off" data-placeholder="Pilih..." class="select-search ">
            <option value=""></option>>
            </select>
        </div>
        </div>
        <div class="col-md-4">
            ...
            <select name="table_stase_idtable_stase" id="table_stase_idtable_stase"
             autocomplete="off"data-placeholder="Pilih..." class="select-search ">
             <option value=""></option>>
        </select>
        </div>
        ...
        <div class="form-group">
             <label >N. FORM %</label>
             <input type="text" disabled="disabled" name="g_cost" id="g_cost" class="form-control bg-success" >
        </div>
        </div>
        </div>
        </fieldset>
    <fieldset title="2">
        ...
        <div class="form-group">
             <label>NILAI %</label>
             <input type="text" disabled="disabled" onkeydown="return numbersonly(this, event);" onchange="sum();" onkeyup="sum();"  name="waktu" id="waktu" class="form-control bg-success" />
        </div>
        </div>
        </div>
        <div class="row">
        ...
        <div class="col-md-6">
             <div class="form-group">
             <label>NILAI %</label>
             <input type="text" disabled="disabled" name="pf" id="pf" class="form-control bg-success"/>
        </div>
        </div>
        </div>
      </fieldset>
      <fieldset title="3">
        ...
        <div class="form-group">
             ...
             <input type="text" disabled="disabled" name="investasi_awal" id="investasi_awal" class="form-control bg-success">
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-group">
             <label>NILAI HURUF</label>
             <input type="text" disabled="disabled" name="kd_proyek" id="kd_proyek" class="form-control bg-success" >
        </div>
        </div>
        <div class="col-md-6">
        <div class="form-group">
