           ...
           <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" readonly="readonly" name="nim" id="nim" placeholder="NIM" value="<?php echo $nim; ?>" />
                                    ...
                                    <fieldset>
                                       <br>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" name="angkatan" readonly="readonly" id="angkatan" class="form-control" placeholder="Tahun Angkatan" value="<?php echo $angkatan; ?>">
