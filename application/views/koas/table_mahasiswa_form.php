...
?>
 ...
 <div class="page-container">
    ...
    <h2 style="margin-top:0px"><?php echo $button ?> Data Koas</h2>
    ...
    <div class="form-group">
     <label class="col-lg-3 control-label">Email </label>
        <div class="col-lg-9">
        <input type="text" name="email" id="email" placeholder="email@mail.com" class="form-control">
    </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <a href="<?php echo site_url('admin/koas') ?>" class="btn btn-danger"><i class=" icon- icon-cancel-circle2"></i> Batal</a>
