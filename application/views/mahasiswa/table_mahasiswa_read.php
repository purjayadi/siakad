...
?>
 <div class="page-container">
        ...
        <h2 style="margin-top:0px">Detail Data Mahasiswa <?php echo $nama_mahasiswa; ?> </h2>
	...
	<div class="text-right">
       <a href="<?php echo site_url('admin/Mahasiswa') ?>" class="btn btn-danger"><i class=" icon- icon-cancel-circle2"></i> Kembali</a>
     </div>
