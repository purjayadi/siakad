	...
	if ($this->form_validation->run() == true)
		{
			...
			else
			{
				...
				//$this->session->set_flashdata('message', "<div class=\"alert alert-info alert-styled-left alert-arrow-left alert-component\" id=\"alert\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\"><span>×</span><span class=\"sr-only\">Close</span></button>incorect login</div>");
		...
		else
		{
			...
			elseif ($this->session->userdata('status')=='tidak_aktif') {
				session_destroy();
				return show_error('Akun anda belum aktif, silahkan hubungi admin untuk mengaktifkan user anda.');
            	$this->_render_page('login', $this->data);
				return false;
			}
		}
		else {
			$this->session->set_flashdata("message", "<div class=\"alert alert-info alert-styled-left alert-arrow-left alert-component\" id=\"alert\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\"><span>×</span><span class=\"sr-only\">Close</span></button>Cek username or password</div>");
			session_destroy();
			redirect('login');
			return false;
		}*/
